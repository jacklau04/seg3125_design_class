...
function populateListProductChoices() {
  ...
  selectedItems()
    ...
    var s6 = document.getElementById("premade").checked;
    ...
    var optionArray = restrictListProducts(products, s1, s2, s3, s4, s6);
...
function selectedItems(){
  ...
  c.appendChild(document.createTextNode("Congrats, you have save $" + getTotalSave(chosenProducts) + " with us today!"));
  c.appendChild(document.createElement("br"));
  c.appendChild(document.createElement("br"));
...
function openTabInfo(tabName) {
  selectedItems()
	...
	// Show the current tab, and add an "active" class to the button that opened the tab
	document.getElementById(tabName).style.display = "block";
  document.getElementById("product-page").className = "";
  document.getElementById("Cart-page").className = "";

  if (tabName == "Client"){
    document.getElementById("client-default").className = " active";
  }
}

function shopNow(tabName) {
  selectedItems()
	// Get all elements with class="tabcontent" and hide them
	tabcontent = document.getElementsByClassName("tabcontent");
	for (i = 0; i < tabcontent.length; i++) {
	...
	// Show the current tab, and add an "active" class to the button that opened the tab
	document.getElementById(tabName).style.display = "block";
  document.getElementById("client-default").className = "";
  document.getElementById("Cart-page").className = "";
  document.getElementById("product-page").className = " active";
}

function CartNow(tabName) {
  selectedItems()
	// Get all elements with class="tabcontent" and hide them
	tabcontent = document.getElementsByClassName("tabcontent");
	for (i = 0; i < tabcontent.length; i++) {
  ...
  document.getElementById("client-default").className = "";
  document.getElementById("product-page").className = "";
  document.getElementById("Cart-page").className = " active";
}
